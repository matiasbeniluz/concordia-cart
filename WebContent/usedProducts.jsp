...
<html>
<head>
    <title>Concordia Cart - Used Products</title>
    <meta charset="utf-8">
...
<jsp:include page="header.jsp">
    <jsp:param name="isUsedProductsPage" value="1" />
</jsp:include>
    ...
    <div class="row text-center">
        ...
        <div class="col-sm-4" style='height: 350px;'>
            <div class="thumbnail">
                ...
                <p class="price">
                    <% if (product.getCurrentPrice() != product.getProdPrice()) { %>
                        On Sale! Original Price: Rs.<%=product.getProdPrice()%> Sale Price: Rs.<%=product.getCurrentPrice()%>
                    <% } else { %>
